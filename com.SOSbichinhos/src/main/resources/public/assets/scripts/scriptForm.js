document.addEventListener("DOMContentLoaded", () => {
    ...
    function insertForm() {
	   ...
	   const inputCiente = document.querySelector("#ciente").checked; 
	   const inputTeveAnimal = document.querySelector("#teveAnimal").checked; 
	   ...
	   const inputImagemAnimal = document.querySelector("#url_imagem").value;
		...
		saveForm(formulario).then(() => {
		    // Limpa os campos apos a submissao
	...
	modalBody.addEventListener("click", function(event) {
	    if (event.target.classList.contains("botao-detalhar")) {
	        ...
	        getForm(fillFormWithAnimalData, id); // Chama função para preencher o formulário com os dados do animal
	    }
